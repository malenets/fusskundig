...
const SINGLE_IMAGE = graphql`
	{
		img1: file(relativePath: { eq: "prod/analyse1.jpg" }) {
			childImageSharp {
				fluid(maxWidth: 800) {
...
export default function Fussanalyse() {
	return (
		<StaticQuery
			query={SINGLE_IMAGE}
			render={(data) => {
				...
				return (
					<Section>
						<ProductWrapper>
							<h1 className="title">Beratung und Fußanalyse</h1>
							<h2 className="message">Wir nehmen uns Zeit für Sie</h2>
							<Img fluid={img1} className="pic" />
							<ul className="list">
								<li>Individuelle Beratung zu Ihren Füßen</li>
								<li>Beratung zu verschiedenen Behandlungsmethoden</li>

								<li>Empfehlungen zur Richtigen Pflege sowie Produkte die zu Ihrem Hauttyp passen</li>
							</ul>
