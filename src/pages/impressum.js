...
const ImpressumPage = () => (
	<Layout>
		<SEO title="Impressum" />
		<Section>
			<Title message="Fußkundig GbR" title="Impressum" />
			<h5> Angaben gemäß §5 TMG</h5>
			<p>Fußkundig GbR</p>
			<h5>Postanschrift</h5>
			<p>
				Unterrather Str. 180 <br />
				40468 Düsseldorf
			</p>
			<h5>Kontakt</h5>
			<p>
				Telefon: 0211/428881 <br />
			...
			<h5>Die Berufshaftpflichtversicherung wurde abgeschlossen bei:</h5>
			<p>
				AXA Center
				<br />
				Markus van Susteren
			...
			<p>Deutschland</p>
			<h5>Verantwortlich für Journalistisch-redaktionalle Inhalte ist:</h5>
			<p>
				Marlon Schulmeister
				<br /> Unterrather Str. 180 <br />
				40468 Düsseldorf
			</p>
			<h5>Webdesign und SEO / Webperformance</h5>
<p>Foxter Solutions, inh. Pascal Gross</p>
